---
title: "Caso 19.  Distribución Normal Estándar"
...
Entonces, a partir de cualquier variable aleatoria $x$ que siga una distribución ![](https://www.fisterra.com/mbe/investiga/distr_normal/images/Image19.gif), se puede obtener otra característica $z$ con una distribución normal estándar, sin más que efectuar la transformación conforme y de acuerdo a la fórmula.
...
La población tiene una variable aletoria de interés como lo puede ser la altura de las personas. Valores medidos en centímetros.

![](images/estaturas.png){width="450"}

Se inicializan variables para generar valores aleatorios y simular una población.
...
En la siguiente función se hace una simulación de transforma cualquier valor de $x$ a valores de $z$. Se simula transformar valores de 170 a 180 de 0.5 en 0.5.
