---
title: "Caso 7. Factorial y Permutaciones"
...
$$
S=Pn\binom{n}{r} = \frac{n!}{(n-r)!}\\S \text{ es el espacio muestral y la cantidad de permutaciones} \\Pn \text{ es el número de permutaciones posibles}\\ \binom{n}{r} \text {es símbolo de permutar n elements en grupos de r}\\ n \text{ es el total de elementos}\\ r \text{ es de cuantos en cuantos elementos se hacen grupos y permutaciones}
$$
