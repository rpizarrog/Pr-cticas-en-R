---
title: "Caso 21 Distribución T Student. Aproximación Normal"
...
R: *dt(), pt(), qt y rt()* y la función xpt() de la librería mosaic para
graficar *T Student* y para el tratamiento de este tipo de
distribuciones. [@tdistribution].
...
**60**. Calcular el valor de *t*. $n=25; \bar=62.1; s=5.83; \mu=60$
...
el color morado y amarillo en la gráfica siguiente y se interpreta para
comparar con un punto crítico y evaluar evaluar intervalos e hipótesis.
...
tabla <- data.frame(x, dens.z, denst.27, denst.5)
...
Determinar el intervalo de confianza con el valor de t inicial
