...
de la muestra está en dicho intervalo de tal forma que se acepta o se
rechaza en relación a la región o área de aceptación o si está en el
...
valor de la media es `r media.p` es posible a un 95% que esté dentro de
