...
-   f significia la frecuencia, la suma de f debe dr el total de elementos.

-   rf significa frecuencia relativa la suma de rf debe ser el 1
...
media_edades2 <- mean(edades1)

varianza_edades1 <- var(edades1)
varianza_edades2 <- var(edades1)
