...
```{r}
playeras <- subset(S, productos == "PLAYERA")
playeras

n.playeras <- nrow(playeras)

paste("Existen ", n.playeras, " de opciones de elegir una playera de entre todo el espacio muestral", ", representan ",  round(n.playeras / N,2) * 100, "%  del total del espacio muestral")
```
