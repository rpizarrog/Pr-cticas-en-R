---
title: "Caso 5. Técnicas de conteo. Principio Aditivo, Multipiativo, Diagrama de arbol."
...
Aplicar y simular algunas técnicas de conteo
...
Las técnicas de conteo son estrategias matemáticas usadas en probabilidad y estadística que permiten determinar el número total de casos o eventos o situaciones a partir de hacer contabilizar cada uno de ellos dentro de un espacio muestral.
...
![Diagrama de árbol para probabilidad de productos](images/Arbol%20de%20decisiOn%20productos-02.jpeg "Diagrama de árbol para probabilidad de productos")
...
De las preguntas 1 a 3, conteste descriptivamente, de las preguntas 4 en adelante realice el cálculo de probabilidades y muestre los resultados como lo indica la pregunta 4.
