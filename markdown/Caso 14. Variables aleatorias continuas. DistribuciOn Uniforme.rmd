---
title: "Caso 14. Variables aleatorias continuas. Distribución Uniforme"
...
miembro de la familia, todos los intérvalos de igual longitud en la
...
intérvalo . Así : dada una variable aleatoria continua, $x$ , definida
en el intervalo $[a,b]$ de la recta real, se dice que $x$ tiene una
distribución uniforme en el intérvalo $[a,b]$.
...
[\@lifeder]](images/funcion%20densidad%20distribucion%20uniforme-01.jpg "Función de densidad distribución uniforme")
...
-   $a$ y $b$ son los valores del intérvalo mínimo y máximo
    respectivamente.
...
![](images/vuelo%20Chicago%20NY.jfif){width="320"}
...
Se inicializan y utiliza las variables *a.min* y *b.max* como
...
Si el área total de manera uniforme en un intérvalo de 120 a 140 es es
0.05, entonces en un intérvalo de 120 a 130 es la mitad del área.
...
intérvalo que por supuesto están dentro del intérvalo original de 120 y
140.
...
densidad es de $0.05$ y el intérvalo es de $10$ o sea $130 -120$
entonces el área bajo la curva es de $0.05 * 10 = 0.50$.

La probabilidad de que el vuelo tarde de $128 \text{ a } 136$ minutos,
significa que hay un intérvalo de $8$ minutos y si se multiplica por la
